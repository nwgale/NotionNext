  ...
  return (
    <div
      ...
      <div className='block'>
        <SmartLink
          href={post.href}
          className='inline-block rounded-sm text-gray-500 dark:text-gray-400 text-xs dark:border-gray-800 border hover:text-red-400 transition-all duration-200 hover:border-red-300 h-9 leading-8 px-5'>
          Continue Reading{' '}
