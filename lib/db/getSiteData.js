...
const isUsableSiteData = data =>
  !!data && Array.isArray(data?.allPages) && !isFallbackSiteData(data)
...
export async function getGlobalData({
  ...
  // In CI/export pipeline, fallback means build result is invalid.
  if (isFallbackSiteData(data) && (process.env.EXPORT || process.env.CI)) {
    throw new Error(
      '[Build Fatal] Notion data unavailable, fallback data detected.'
    )
  }
