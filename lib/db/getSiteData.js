...
function getLatestPosts({ allPages, from, latestPostCount }) {
  ...
  // 确保返回的数据中所有字段都不是undefined
  return latestPosts.slice(0, latestPostCount).map(post => ({
    ...post,
