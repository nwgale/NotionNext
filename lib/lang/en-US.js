export default {
  ...
  SYNC_ADMIN: {
    TITLE: 'Sync Site Content',
    DESCRIPTION: 'Click the button below to fetch the latest articles from Notion and deploy them to the domestic server.',
    PASSWORD_PLACEHOLDER: 'Enter sync password',
    SYNC_BUTTON: 'Start Sync',
    SYNCING: 'Syncing...',
    SUCCESS: 'Sync request triggered successfully! The site content will be updated in a few minutes.',
