...
export default async function getPageProperties(
  ...
  properties.type = properties.type?.[0] || null
  properties.status = properties.status?.[0] || null
  properties.category = properties.category?.[0] || null
  properties.comment = properties.comment?.[0] || null
