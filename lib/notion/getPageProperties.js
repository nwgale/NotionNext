...
export default async function getPageProperties(
  ...
  // Sitemap-related date debugging
  console.log(`\n[SITEMAP_DEBUG] ---- START ----`);
  console.log(`[SITEMAP_DEBUG] Page: ${properties.title} (${properties.slug || properties.id})`);
  console.log(`[SITEMAP_DEBUG]   Raw last_edited_time: ${value?.last_edited_time} (${new Date(value?.last_edited_time)})`);
  console.log(`[SITEMAP_DEBUG]   Raw created_time: ${value?.created_time} (${new Date(value?.created_time)})`);
  console.log(`[SITEMAP_DEBUG]   Raw date.start_date: ${properties?.date?.start_date}`);
  ...
  console.log(`[SITEMAP_DEBUG]   => Calculated lastEditedDate: ${properties.lastEditedDate} (Type: ${typeof properties.lastEditedDate})`);
  console.log(`[SITEMAP_DEBUG]   => Calculated publishDate: ${properties.publishDate} (Type: ${typeof properties.publishDate})`);
  console.log(`[SITEMAP_DEBUG] ---- END ----`);
